 ...
 * destroy
 */
ogc_image_datum :: ~ogc_image_datum()
{
}
 ...
 * object from WKT
 */
ogc_image_datum * ogc_image_datum :: from_wkt(
   const char * wkt,
   ogc_error *  err)
{
   ogc_image_datum * obj = OGC_NULL;
 ...
 * clone
 */
ogc_image_datum * ogc_image_datum :: clone(const ogc_image_datum * obj)
{
   if ( obj == OGC_NULL )
      return OGC_NULL;
   return obj->clone();
...
ogc_image_datum * ogc_image_datum :: clone() const
{
 ...
 */
bool ogc_image_datum :: is_equal(
   const ogc_image_datum * p1,
